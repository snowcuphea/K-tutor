    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(default='temp_nick', max_length=30)),
                ('level', models.IntegerField(default=1)),
                ('exp', models.IntegerField(default=0)),
                ('consecutive_access', models.IntegerField(default=1)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('learned_kw', models.ManyToManyField(related_name='learned_user', to='klass.Kw')),
                ('learned_lc', models.ManyToManyField(related_name='learned_user', to='klass.Lc')),
